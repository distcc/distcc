...
#define HAVE_LIBIBERTY_LIBIBERTY_H 1

/* Define to 1 if you have the `popt' library (-lpopt). */
#define HAVE_LIBPOPT 1

/* Define to 1 if the host system type is Linux. */
#define HAVE_LINUX 1
...
#define HAVE_UNDERSCORE_UNDERSCORE_VA_COPY 1
...
/* Native compiler triple */
#define NATIVE_COMPILER_TRIPLE "x86_64-linux-gnu"
...
#define PACKAGE_STRING "distcc 3.4"
