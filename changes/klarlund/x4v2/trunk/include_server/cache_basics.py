...
class RelpathMapToIndex(MapToIndex):
  ...
  def Index(self, relpath, ignore_absolute_path_warning=False):
    ...
    The variable ignore_absolute_path_warning is True when the Resolve procedure
    is used to probe the source file on the command line or files of -include
...
class CanonicalMapToIndex(MapToIndex):
  ...
  def Index(self, filepath, *extra_args):
