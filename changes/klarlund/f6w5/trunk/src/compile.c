...
/* TODO(klarlund) Make this constant configurable. Also do not change this
   constant without changing the Warning message in the pump script that
   discc-pump was disabled: it should only be printed if the discrepancy
   counter is at least max_discrepancies_before_demotion. */
